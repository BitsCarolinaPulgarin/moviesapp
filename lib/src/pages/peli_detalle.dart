...
class PeliculaDetalle extends StatelessWidget {
  ...
  Widget _crearCasting (Pelicula pelicula){
    ...
    final peliProvider = new PeliculasServices();
    ...
    return FutureBuilder(
      ...
      builder:(context, AsyncSnapshot<List> snapshot){
        ...
        if(snapshot.hasData){
          return _crearActoreesPageView(snapshot.data);
        }else{
  ...
  Widget _crearActoreesPageView(List<Actor> actores){
      ...
      child: Column(
        children: <Widget>[
          ClipRRect(
            borderRadius: BorderRadius.circular(20.0),
            child: FadeInImage(
              image: NetworkImage(actor.getPostImg()),
